		        ...
		        confirm.setOnClickListener(new View.OnClickListener() {
					...
					public void onClick(View arg0) {
						...
						try {
							...
							String url = "http://10.100.9.191/doctor_reg.php?DOCTOR_NAME="+ doctor_name.trim() + "&USERNAME=" + username.trim()+ "&PASSWORD="+ password.trim()+ "&CONFIRM_PASSWORD="+ confirm_pwd.trim()+ "&PHONE_NUMBER="+ ph_no.trim()+ "&EMAILID="+ email.trim()+ "&SPECIALIST="+ specialist.trim()+ "&EXPERIENCE="+ experience.trim();
