	        ...
	        confirm.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					try {
						...
						String url = "http://10.100.9.191/patientreg.php?PATIENT_NAME="+ patient_name.trim() + "&AGE="+ age.trim() + "&GENDER=" + gender.trim() + "&USERNAME=" + username.trim()+ "&PASSWORD="+ pwd.trim()+ "&CONFIRM_PWD="+ confirm_pwd.trim()+ "&PHONE_NO="+ ph_no.trim()+ "&EMAILID="+ email.trim()+ "&ADDRESS="+ address.trim();
